...
predict = clf.predict(["#Azure information regarding #Florence. 1. Please be safe. 2. We're on it. Contact support through normal channels. @AzureSupport also standing by."])
